...
| **Faded Bounces** (низка база + ↑) | -0.44% | 44.7% | ⚠ Avoid — обикновено избледняват |
| Chronic Losers (низка база + →↓) | +0.41% | 47.5% | Без сигнал |
...
- **Без vol normalization**: създаваше defensive bias (низко-вол акции системно водеха)
...
| | Висока база (≥p80) | Низка база (≤p20) |
|---|---|---|
